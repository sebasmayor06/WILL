...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      var nuevoarray = this.amigos.map(function (nombresamigos) {
        return nombresamigos.nombre;
      })
      return nuevoarray;
    }
    ...
    getPromedioEdad() {
      ...
      var suma = 0;
      var prom = 0;
      var promedio = this.amigos.map(function (edadesamigos) {
        return edadesamigos.edad;
